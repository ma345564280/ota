$(document).ready(function () {
    ...
    $("#sidebar_service").load("sidebar_service.html", function () {
    	if(sessionStorage.getItem("sidebar")=="siderbar_service") {
    		$('#header_service').addClass="active";
    		if (sessionStorage.getItem("active") == null) {
                $("#service_ipblock").addClass("active");
                $("#service_ipblock").parent().parent().parent().addClass("in");
            } else {
...
function header_deviceClick() {
	$('#header_service').addClass=("active");
	$("#service_ipblock").addClass("active");
	sessionStorage.setItem("active", "service_ipblock");
    $("#service_ipblock").parent().parent().parent().addClass("in");
}
